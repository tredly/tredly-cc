...
BINDIR="/tredly/ptn/default/data/tredly-ui"
...
if [ -z "$1" ]
    then
        echo -e "\u001b[32m\u001b[1m    Using default URL: tredlyui.example.com \u001b[22m\u001b[39m"
    else
        echo -e "\u001b[32m\u001b[1m    Using custom URL: $1 \u001b[22m\u001b[39m"
        sed -i -e "s,tredlyui.example.com,$1,g" "${BINDIR}/Tredlyfile"
        sed -i -e "s,tredlyui.example.com,$1,g" "${BINDIR}/server.js"
fi
